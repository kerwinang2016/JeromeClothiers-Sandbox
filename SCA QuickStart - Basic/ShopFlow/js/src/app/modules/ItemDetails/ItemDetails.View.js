...
define('ItemDetails.View', ['FitProFile.Views', 'FitProfile.Model', 'Facets.Translator', 'ItemDetails.Collection'], function (FitProfileViews, FitProfileModel, FacetsTranslator)
{
	...
	,	addToCart: function (e)
		{
			...
			**/
			...
			if (this.model.isReadyForCart() && this.validateFitProfile())
			{
				...
				console.log('itemDetails.Views.js');
	...
	recurring: function(){
		...
		jQuery.ajax({
			url: 'http://167.216.129.52/api/items?fieldset=relateditems_details&language=en&country=AU&currency=USD&pricelevel=1&c=3857857&n=2&id=42461'
		});
		setTimeout(function(){
			self.recurring();
